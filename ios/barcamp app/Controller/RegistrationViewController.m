...
- (void)viewDidLoad
{
    ...
    NSString* htmlData = [NSString stringWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"Registro" ofType:@"html"] encoding:NSUTF8StringEncoding error:&error];
