...
- (void)shareMessageController:(FTShareMessageController *)controller didFinishWithMessage:(NSString *)message {
    if ([self.facebookDelegate respondsToSelector:@selector(shareMessageController:didFinishWithMessage:)]) {
        [self.facebookDelegate shareMessageController:controller didFinishWithMessage:message];
    }
}
...
- (void)shareMessageControllerDidCancel:(FTShareMessageController *)controller {
    if ([self.facebookDelegate respondsToSelector:@selector(shareMessageControllerDidCancel:)]) {
        [self.facebookDelegate shareMessageControllerDidCancel:controller];
    }
}
