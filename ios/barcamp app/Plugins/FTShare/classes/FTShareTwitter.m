...
- (void)shareMessageController:(FTShareMessageController *)controller didFinishWithMessage:(NSString *)message {
    if ([self.twitterDelegate respondsToSelector:@selector(shareMessageController:didFinishWithMessage:)]) {
        [self.twitterDelegate shareMessageController:controller didFinishWithMessage:message];
    }
}
...
- (void)shareMessageControllerDidCancel:(FTShareMessageController *)controller {
    if ([self.twitterDelegate respondsToSelector:@selector(shareMessageControllerDidCancel:)]) {
        [self.twitterDelegate shareMessageControllerDidCancel:controller];
    }
}
