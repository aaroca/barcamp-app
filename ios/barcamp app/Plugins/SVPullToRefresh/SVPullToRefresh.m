...
- (void)setPullToRefreshActionHandler:(void (^)(void))actionHandler {
    ...
    titleLabel.text = NSLocalizedString(@"Tira para actualizar...",);
...
- (void)setLastUpdatedDate:(NSDate *)newLastUpdatedDate {
    self.dateLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Actualizado: %@",), newLastUpdatedDate?[self.dateFormatter stringFromDate:newLastUpdatedDate]:NSLocalizedString(@"Nunca",)];
}

- (void)setDateFormatter:(NSDateFormatter *)newDateFormatter {
	dateFormatter = newDateFormatter;
    self.dateLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Actualizado: %@",), self.lastUpdatedDate?[newDateFormatter stringFromDate:self.lastUpdatedDate]:NSLocalizedString(@"Nunca",)];
}
...
- (void)startAnimating{
    ...
    titleLabel.text = NSLocalizedString(@"Cargando...",);
    ...
    if(pullToRefreshActionHandler) {
        switch (newState) {
            ...
            case SVPullToRefreshStateTriggered:
                titleLabel.text = NSLocalizedString(@"Suelta para actualizar",);
